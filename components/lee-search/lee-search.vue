	...
	<view :class="['search-input', btnLinkInput ? 'btn-link-input' : '']" :style="{ height: getHeight }">
		...
		<view
			...
			:style="{
				...
				border: getBtnBorder,
				borderWidth: getBtnBorderWidth,
				lineHeight: getHeight,
				paddingLeft: getBtnPaddingLeft,
				paddingRight: getBtnPaddingRight,
				backgroundImage: getBtnBackgroundImage,
				bacbackgroundPosition: getBtnBackgroundPosition,
				backgroundSize: getBtnbackgroundSize
			}"
			@click="btnClick"
		>
			{{ getBtnText }}
		...
		<view class="voice-module" v-if="openVoice">
			<cover-view
				...
				:style="{
					backgroundColor: recording ? getVoiceAttrBtnBackgroundActiveColor : getVoiceAttrBtnBackgroundColor,
					color: recording ? getVoiceAttrBtnActiveColor : getVoiceAttrBtnColor
				}"
				@touchstart="startHandel"
				@touchend="endHandle()"
				@touchcancel="endHandle()"
			>
				{{ recording ? getVoiceAttrActiveText : getVoiceAttrText }}
			</cover-view>
